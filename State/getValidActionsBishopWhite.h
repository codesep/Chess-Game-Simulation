/*
	...
	Member Function: getValidActionsBishopWhite
	
	Returns a vector containing valid actions, i.e. a piece and it's final position for a white Bishop.
*/

vector< pair<string, string> > State::getValidActionsBishopWhite(pair<int, char> pos){

	// vector of valid actions for a white Bishop
