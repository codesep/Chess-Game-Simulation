/*
	...
	Member Function: getValidActionsRookWhite
	
	Returns a vector containing valid actions, i.e. a piece and it's final position for a white rook.
*/

vector< pair<string, string> > State::getValidActionsRookWhite(pair<int, char> pos){

	// vector of valid actions for a white rook
