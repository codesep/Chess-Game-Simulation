/*
	...
	Member Function: getValidActionsQueenWhite
	
	Returns a vector containing valid actions, i.e. a piece and it's final position for a white Queen.
*/

vector< pair<string, string> > State::getValidActionsQueenWhite(pair<int, char> pos){

	// vector of valid actions for a white Queen
